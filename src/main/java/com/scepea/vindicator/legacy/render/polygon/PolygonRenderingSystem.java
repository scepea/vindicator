...
public class PolygonRenderingSystem extends EntitySystem {
    ...
    @Inject
    public PolygonRenderingSystem(Provider<ShapeRenderer> shapeRenderer, TransformEntityService transformEntityService, OrthographicCamera orthographicCamera) {

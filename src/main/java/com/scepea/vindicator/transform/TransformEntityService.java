...
import com.scepea.vindicator.transform.component.ParentTransformComponent;
...
public class TransformEntityService {
    ...
    public List<Transform> buildTransformList(Entity entity){
        ...
        for (TransformComponent transformComponent : entityService.getAllMatchingComponentsInEntityBranch(entity, ParentTransformComponent.class, TransformComponent.class)){
